...
const ImportExcelErrorBlackListModal = ({ openModalImportExcelErrorBlackList, dataIncorrect }) => {
    ...
    return (
        <div>
            <Dialog
                open={openModalImportExcelErrorBlackList}
                fullWidth
                maxWidth="md"
                TransitionComponent={Transition}
                keepMounted
                onClose={handleClose}
                aria-describedby="modal-import-excel-error-blacklist"
            >
                <DialogContent>
...
ImportExcelErrorBlackListModal.propTypes = {
    openModalImportExcelErrorBlackList: PropTypes.bool,
    dataIncorrectData: PropTypes.any
};

export default ImportExcelErrorBlackListModal;
