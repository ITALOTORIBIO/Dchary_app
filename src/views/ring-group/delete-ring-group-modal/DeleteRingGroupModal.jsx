...
const DeleteRingGroupModal = ({
    ...
    let initialValues = {
        name_group: resultItemRingGroup.name_group
    };

    useEffect(() => {}, [initialValues.name_group, openModalRingGroupDelete]);
    ...
    const handleCallToDeleteRingGroupItem = async () => {
        ...
        const result = await callToDeleteRingGroupItem(initialValues.name_group);
        if (result) {
            getDataRingGroup();
