...
const ImportExcelErrorRingGroupModal = ({ openModalImportExcelErrorRingGroup, dataIncorrect }) => {
    ...
    return (
        <div>
            <Dialog
                open={openModalImportExcelErrorRingGroup}
                fullWidth
                maxWidth="md"
                TransitionComponent={Transition}
                keepMounted
                onClose={handleClose}
                aria-describedby="modal-import-excel-error-ring-grpu"
            >
                <DialogContent>
...
ImportExcelErrorRingGroupModal.propTypes = {
    openModalImportExcelErrorRingGroup: PropTypes.bool,
    dataIncorrectData: PropTypes.any
};

export default ImportExcelErrorRingGroupModal;
