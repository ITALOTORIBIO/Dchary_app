...
const ListPreviewImportRingGroup = ({ dataImportExcelRingGroup }) => {
    ...
    return (
        <Paper sx={{ width: '100%', overflow: 'hidden' }}>
                ...
                <Table stickyHeader size="small" sx={{ borderCollapse: 'collapse !important' }}>
                    ...
                    <TableBody>
                        {!dataImportExcelRingGroup ? (
                            ...
                            dataImportExcelRingGroup.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, index) => {
                                return (
                                    <TableRow
                                        hover
                                        role="checkbox"
            ...
            <TablePagination
                ...
                component="div"
                count={dataImportExcelRingGroup.length}
...
ListPreviewImportRingGroup.propTypes = {
    dataImportExcelRingGroup: PropTypes.any
};

export default ListPreviewImportRingGroup;
