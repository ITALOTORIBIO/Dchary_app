...
function createData(index, nameArea, totalCalls, totalTime, avgTime, minTime, maxTime) {
    return { index, nameArea, totalCalls, totalTime, avgTime, minTime, maxTime };
}
...
export default ListInformationCallArea;
