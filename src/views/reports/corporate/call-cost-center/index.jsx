...
import ListInformationCallCostCenter from './list-information-call-cost-center/ListInformationCallCostCenter';

const areas = ['General', 'Todas'];
const costCenters = ['Todos', 'General'];
const ordering = ['Nombre de Centro de Costo', 'Cantida de Llamadas', 'Tiempo Conversado', 'Tiempo Promedio'];
...
const CallCostCenter = () => {
    ...
    const handleChangeCostCenter = (event) => setCostCenter(event.target.value);
                ...
                <Grid item width="100%">
                    <MainCard>
                        <Grid container spacing={gridSpacing}>
                            <Grid item xs={12}>
                                <Grid container>
                                    <Typography variant="h4">Lista de Llamadas por Centro de Costo</Typography>
                                </Grid>
                            </Grid>
                            <Grid item xs={12}>
