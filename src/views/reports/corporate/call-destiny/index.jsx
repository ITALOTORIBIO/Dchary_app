...
import ListInformationCallDestiny from './list-information-call-destiny/ListInformationCallDestiny';

const destinies = ['Todas', 'Fijo Local', 'Fijo Nacional'];
const ordering = ['Nombre de Destino', 'Cantidad de Llamadas', 'Duracion'];
