...
import ListInformationCallRanking from './list-information-call-ranking/ListInformationCallRanking';

const ordering = ['Cantidad de llamadas', 'Tiempo de conversación'];
                ...
                <Grid item width="100%">
                    <MainCard>
                        <Grid container spacing={gridSpacing}>
                            <Grid item xs={12}>
                                <Grid container>
                                    <Typography variant="h4">Lista de Llamadas por Ranking</Typography>
                                </Grid>
                            </Grid>
                            <Grid item xs={12}>
