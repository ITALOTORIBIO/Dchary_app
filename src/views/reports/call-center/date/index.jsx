...
import ListInformationCallCenterListDate from './list-information-call-center-list-date/ListInformationCallCenterListDate';
...
const CallListDate = () => {
    ...
    const handleClickSearchCallListDate = () => {
        ...
        <>
            <Grid container spacing={gridSpacing}>
                        ...
                        <Grid container spacing={gridSpacing}>
                            ...
                            <Grid item>
                                <Button
                                    ...
                                    variant="contained"
                                    endIcon={<Search />}
                                    onClick={handleClickSearchCallListDate}
                                >
                                    Buscar
                                </Button>
                            </Grid>
                ...
                {showInformation && (
                    <Grid item width="100%">
                        <MainCard>
                            <ListInformationCallCenterListDate />
                        </MainCard>
                    </Grid>
                )}
            </Grid>
