...
import { menuOpen, setMenu } from 'store/drawer';

const NavItem = ({ item, level }) => {
    const theme = useTheme();
    const dispatch = useDispatch();
    const { isOpen, borderRadius } = useSelector((state) => state.toogle);
    ...
    return (
        ...
        >
            <ListItemIcon sx={{ my: 'auto', minWidth: !item?.icon ? 18 : 36, color: customPalette.darkLightSoft }}>{itemIcon}</ListItemIcon>
            <ListItemText
                primary={
