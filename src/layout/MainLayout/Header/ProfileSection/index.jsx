...
import { validateUserLogout } from 'store/auth';

const ProfileSection = () => {
    const theme = useTheme();
    const { borderRadius } = useSelector((state) => state.toogle);
    ...
    const handleLogout = async () => {
        dispatch(validateUserLogout(token));
        ...
        <>
            <Chip
                sx={{
                    ...
                    borderColor: `${theme.palette.primary.main}10`,
                    ...
                    <Transitions in={open} {...TransitionProps}>
                        <Paper>
                            <ClickAwayListener onClickAway={handleClose}>
                                <MainCard border={false} elevation={4} content={false} boxShadow shadow={theme.shadows[16]}>
